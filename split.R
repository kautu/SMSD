...
var5 <- VAR(linkage[, c('CMT_1MONTH', 'KOF', 'R3M')][598:2811,], p = 5, type = 'both')
...
var3 <- VAR(weekly[, c('CISS', 'KOF', 'R3M')][128:584,], p = 3, type = 'both')
...
vecm <- ca.jo(log(larger[,c('M2', 'TMC', 'CR3M')][31:148,]), 
